...
gpointer data) 
{
  g_print ("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA on_pad_added \n");
...
gpointer data) 
{
   g_print ("BBBBBBBBBBBBBBBBBBBB on_pad_added_parser \n");
...
{ 
  ...
  std::string filename;
  if (argc != 2) { 
    filename = "/home/truongtv/bt/gstreamer/videoplayback.mp4";
  }else
    filename = argv[1];
