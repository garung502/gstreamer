...
#define DEFAULT_EFFECTS "file:///home/truongtv/bt/gstreamer/file_audio/ghita.flac,file:///home/truongtv/bt/gstreamer/file_audio/Awake.flac," \
    "file:///home/truongtv/bt/gstreamer/file_audio/Dancing.flac,file:///home/truongtv/bt/gstreamer/file_audio/Move.flac"
...
main (int argc, char **argv)
{
  ...
  if (opt_effects != NULL) {
    g_print ("ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ CASE_1:");
    effect_names = g_strsplit (opt_effects, ",", -1);
  }
  else {
    g_print ("ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ CASE_2:");
  ...
  for (e = effect_names; e != NULL && *e != NULL; ++e) {
    ...
    */
    el = gst_element_factory_make ("uridecodebin", NULL);
    if (el) {
       g_object_set (el, "uri", *e, NULL);
       g_print ("Adding effect '%s'\n", *e);
       g_queue_push_tail (&effects, el);
    }
    //i++;
  ...
  src = gst_element_factory_make ("audiotestsrc", "audio_source");
 ...
 */
  q1 = gst_element_factory_make ("queue", "audio_queue_1");

  blockpad = gst_element_get_static_pad (q1, "src");

  conv_before = gst_element_factory_make ("audioconvert", "audio_convert_1");

  effect = g_queue_pop_head (&effects);
  cur_effect = effect;

  conv_after = gst_element_factory_make ("audioconvert", "audio_convert_2");

  q2 = gst_element_factory_make ("queue", "audio_queue_2");
